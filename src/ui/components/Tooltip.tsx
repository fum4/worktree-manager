    ...
    <>
      ...
      {visible && style && createPortal(
        <div className="fixed z-[9999] pointer-events-none" style={style}>
          <div className={`relative ${transformClass[position]} px-2 rounded-md bg-black border border-white/[0.12] shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center h-[26px]`}>
